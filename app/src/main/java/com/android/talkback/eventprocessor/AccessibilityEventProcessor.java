...
//        }
        ...
        if (AccessibilityEventUtils.eventMatchesAnyType(event, MASK_DELAYED_EVENT_TYPES)) {
            Log.i(TAG, "AccessibilityEventProcessor-onAccessibilityEvent: eventMatchesAnyType");
            mHandler.postProcessEvent(event);
        } else {
            Log.i(TAG, "AccessibilityEventProcessor-onAccessibilityEvent: eventMatchesAnyType else");
            processEvent(event);
        }
